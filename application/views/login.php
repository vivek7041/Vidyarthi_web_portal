...
<head>
    ...
    <?php echo form_error('uname'); ?>
                    ...
                    <div class="card-footer text-center text-black-50">
                        Not yet a student? <a target="blank" href="<?php echo base_url();?>index.php/Welcome/signup">Sign Up</a>
                        <div class="card-footer text-center text-black-50">
                        Login as a <a target="blank" href="<?php echo base_url();?>index.php/Welcome/facultyLogin">Faculty</a>
                    </div>
                </div>
            </div>
        </div>
