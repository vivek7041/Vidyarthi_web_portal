...
<body class="login">
    ...
    <div class="d-flex align-items-center" style="min-height: 100vh">
        <div class="col-sm-8 col-md-6 col-lg-6 mx-auto" style="min-width: 300px;">
            ...
            <div class="card navbar-shadow">
                ...
                <div class="card-body">
                    <?php echo form_open_multipart('Welcome/signup'); ?>
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-label"  for="body">Select Image</label>
                            <?php echo form_upload(['class' => 'form-control form-control-prepended', 'name'=>'userfile','value'=>set_value
                            ('userfile')]); ?>
                            </div>                 
                    ...
                    <div class="form-group">
                        <label class="form-label" for="">Area of Interest</label> 
                            <select class="form-control form-control-prepended" name="aoi"  aria-label="Default select example">
  ...
  <option  name="aoi" valzue="Android development">Android development</option>
